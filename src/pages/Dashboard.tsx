...
export default function Dashboard() {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-hidden lg:overflow-auto lg:overscroll-y-contain no-scrollbar lg:pt-3 lg:px-6 lg:pb-6">
      ...
      <div className="lg:hidden h-full flex flex-col pt-10 px-5 pb-mobile-nav">
        <DashboardHero
          firstName={firstName}
          ...
          className="shrink-0"
          style={{ height: "calc(100dvh - 100vw - 10rem - env(safe-area-inset-bottom, 0px))" }}
        ...
        <div className="mt-1 shrink-0 grid grid-cols-3 gap-3">
          {filteredNavItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "card-elevated shadow-md aspect-square flex flex-col items-center justify-center gap-2 rounded-xl px-2 transition-all duration-200",
                  isActive
