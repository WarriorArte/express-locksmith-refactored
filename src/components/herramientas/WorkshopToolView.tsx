...
export  function  WorkshopToolView({
  ...
  const  selectClass  =
"flex  h-11  w-full  rounded-xl  border  border-primary/20/60  bg-card  px-4  py-2  text-sm  text-foreground  shadow-sm  focus-visible:outline-none  focus-visible:ring-2  focus-visible:ring-blue-500  transition-all  disabled:cursor-not-allowed  disabled:opacity-50  /50  dark:border-foreground  dark:text-slate-200";
