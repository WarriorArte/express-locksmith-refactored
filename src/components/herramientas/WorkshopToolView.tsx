...
export function WorkshopToolView({
  ...
  const selectClass =
    "flex h-11 w-full rounded-xl border border-blue-200/60 bg-white/70 px-4 py-2 text-sm text-slate-800 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-all disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-900/50 dark:border-slate-800 dark:text-slate-200";
