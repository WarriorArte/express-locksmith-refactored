        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {hasYearSpecific && (
                <Badge variant="outline" className="text-[10px] px-1.5 gap-1 border-blue-300 text-blue-600 dark:border-blue-700 dark:text-blue-400">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      {isYearSpecific && (
                        <span className="ml-1.5 inline-flex items-center text-[10px] text-blue-500 font-normal">
                          · año {year}
                        </span>
                      )}
                    </div>
            ...
            <div className="space-y-2 pt-1">
              {dv.notes.map((note) =>
                note.type === "image_variation" ? (
                  <div
                    key={note.id}
                    className="flex items-start gap-2 rounded-lg bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 px-3 py-2.5 text-xs text-amber-800 dark:text-amber-300"
                  >
                  ...
                  <div
                    key={note.id}
                    className="flex items-start gap-2 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 px-3 py-2.5 text-xs text-blue-800 dark:text-blue-300"
                  >
        ...
        <CardHeader className="pb-3 pt-5 px-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4">
              {vehicleImg ? (
                <div className="h-14 w-20 rounded-xl overflow-hidden border border-blue-200 dark:border-blue-800 shrink-0 bg-white">
            ...
            <Button
              ...
              size="sm"
              onClick={onBack}
              className="text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 shrink-0"
            >
          ...
          {/* Multi-profile tabs */}
          {profiles.length > 1 && (
            <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-blue-100 dark:border-blue-900/50">
              {profiles.map((p, i) => (
                <button
                  key={p.id}
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${
                    i === activeIdx
                      ...
                      : "bg-white/70 text-slate-700 hover:bg-white dark:bg-slate-800/60 dark:text-slate-300"
                  }`}
                >
                  {p.nombre}
                </button>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all border ${
                  activeCategory === cat.id
                    ...
                    : "bg-transparent text-muted-foreground border-border hover:border-blue-300 hover:text-foreground"
                }`}
              >
              ...
              return (
                <button
                  ...
                  className={`w-full text-left flex items-center gap-3 px-4 py-3 rounded-xl border transition-all ${
                    isSelected
                      ? "border-blue-400/70 bg-blue-50 dark:bg-blue-950/20"
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {hasImage && <ImageIcon className="w-3.5 h-3.5 text-blue-400" />}
                    {dv.notes && dv.notes.length > 0 && (
