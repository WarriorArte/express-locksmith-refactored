        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {hasYearSpecific && (
                <Badge variant="outline" className="text-[10px] px-1.5 gap-1 border-blue-300 text-primary dark:border-blue-700 dark:text-blue-400">
            ...
            <div className="space-y-2 pt-1">
              {dv.notes.map((note) =>
                note.type === "image_variation" ? (
                  ...
                  <div
                    key={note.id}
                    className="flex items-start gap-2 rounded-lg bg-primary/5 border border-blue-200 dark:border-blue-800 px-3 py-2.5 text-xs text-blue-800 dark:text-blue-300"
                  >
        ...
        <CardHeader className="pb-3 pt-5 px-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <Button
              ...
              size="sm"
              onClick={onBack}
              className="text-muted-foreground hover:text-foreground dark:hover:text-slate-100 shrink-0"
            >
