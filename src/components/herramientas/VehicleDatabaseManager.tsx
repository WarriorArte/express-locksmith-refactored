...
const  CATEGORY_COLORS:  Record<VehicleCategory,  string>  =  {
  Vehiculo:"bg-primary/10  text-primary  border-primary/20  dark:bg-blue-950/40  dark:text-primary",
...
export  function  VehicleDatabaseManager({
  ...
  !categoryFilter  ?"bg-primary  text-primary-foreground  border-primary  dark:bg-muted  dark:text-foreground"  :"text-muted-foreground  border-border  hover:border-border"
  }`}
  >
  Todos
  </button>
