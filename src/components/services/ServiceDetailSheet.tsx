...
export function ServiceDetailSheet({
  ...
  const productsSubtotal =
    service.service_products?.reduce((acc, p) => acc + Number(p.subtotal), 0) || 0;
  ...
  const meta = [
    ...
    { l: "Fecha", v: format(parseISO(service.created_at), "dd MMM yyyy", { locale: es }) },
    { l: "Hora", v: format(parseISO(service.created_at), "HH:mm", { locale: es }) },
  ];
      ...
      <DialogContent fixedHeight disableSwipeToClose={imageViewerOpen} className="max-w-md">
        ...
        <DialogFooter className="pt-1 gap-2">
          ...
          <div className="flex items-center gap-2 w-full">
            ...
            {/* 3 puntos: Ticket, WhatsApp, Cancelar */}
            <DropdownMenu>
