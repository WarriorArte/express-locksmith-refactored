...
- Una sola migracion base: `database/migrations/2026_05_06_000000_create_application_schema.php`.
- En MySQL/MariaDB, esa migracion carga `database/legacy/schema.sql`.
...
Ver tambien: `../docs/LOCAL-LOVABLE-DB.md`.
