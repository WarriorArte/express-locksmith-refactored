...
CREATE TABLE IF NOT EXISTS business_settings (
  ...
  ticket_show_logo TINYINT(1) DEFAULT 1,
  ticket_paper_size VARCHAR(10) DEFAULT '58mm',
...
CREATE TABLE IF NOT EXISTS quote_doc_settings (
  ...
  accent_ink VARCHAR(20) NOT NULL DEFAULT '#1a1f2e',
  header VARCHAR(20) NOT NULL DEFAULT '#1a1f2e',
  header_ink VARCHAR(20) NOT NULL DEFAULT '#ffffff',
  table_head VARCHAR(20) NOT NULL DEFAULT '#1a1f2e',
  table_head_ink VARCHAR(20) NOT NULL DEFAULT '#ffffff',
  muted VARCHAR(20) NOT NULL DEFAULT '#7c7c74',
  soft VARCHAR(20) NOT NULL DEFAULT '#f5f5f3',
  `rule` VARCHAR(20) NOT NULL DEFAULT '#e6e4dd',
  paper VARCHAR(20) NOT NULL DEFAULT '#ffffff',
  logo_size SMALLINT UNSIGNED NOT NULL DEFAULT 110,
  notes TEXT NULL,
