...
final class WarrantySettingsController
{
    ...
    private function upsertSettings(Request $request): JsonResponse
    {
        ...
        if (!LegacyAuth::canAdminWorkshop($authUser['user_id'], $workshopId)) return ApiResponse::error($workshopId ? 'Se requiere rol de administrador en este taller' : 'workshop_id es requerido', $workshopId ? 401 : 400);
