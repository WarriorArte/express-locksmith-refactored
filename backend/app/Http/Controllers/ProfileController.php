...
final class ProfileController
{
    ...
    private function show(Request $request, string $id): JsonResponse
    {
        ...
        if (!$isAllowed) {
            return ApiResponse::error('Sin permisos para ver este perfil', 403);
        }
    ...
    private function update(Request $request): JsonResponse
    {
        ...
        if ($profile->user_id !== $user->id && !$user->isSuperadmin()) {
            return ApiResponse::error('Solo puedes editar tu propio perfil', 403);
        }
